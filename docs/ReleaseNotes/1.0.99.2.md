...
* Issues/Requests
  * closed #41 - Not So SimpleConstruction! (NSSC!) 1.0.99.2-prerelease `<Спасиба деградка>`
  * closed #42 - 1.0.99.2 Verify Legal Mumbo Jumbo
  * closed #43 - 1.0.99.2 Update Documentation
  * closed #44 - 1.0.99.2 Update Social Media
